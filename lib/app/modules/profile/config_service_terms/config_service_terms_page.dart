...
class ConfigServiceTermsPage extends StatefulWidget {
  @override
  _ConfigServiceTermsPageState createState() => _ConfigServiceTermsPageState();
}

class _ConfigServiceTermsPageState extends State<ConfigServiceTermsPage> {
